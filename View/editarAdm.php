...
<body class="custom">
  <div class="container-fluid">
    <div class="row flex-nowrap">
     ...
     <div class="col py-3">
      <div data-bs-spy="scroll" id="editUser" class="container-fluid">
        <h1 class="mt-4 text-center">Meu perfil</h1>
        <br>
        ...
        <div class="p-3 py-5">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" value="<?=$userlog[0]['cep']?>" placeholder="Bairro" disabled>
            </div>
            <div class="col-md-12">
      ...
      <div class="modal-body">
        <form class=""  action="../Controller/AcoesUsuario.php" method="POST">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-6">
              <label class="labels">Bairro</label>
              <input type="text" class="form-control" value="<?=$userlog[0]['cep']?>" placeholder="Bairro" name="bairro">
            </div>
            <div class="col-md-12">
              <label class="labels">Telefone</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class=""  action="../Controller/AcoesUsuario.php" method="POST">
          ...
          <div>
            <div class="col-md-12">
              <label class="labels">Digite a senha antiga</label>
              <input type="text" class="form-control" placeholder="Senha antiga">
            </div>
            <div class="col-md-12 py-3">
              <label class="labels">Digite a senha nova</label>
              <input type="text" class="form-control" placeholder="Senha nova">
            </div>
          </div>
          <br>
          <div class="modal-footer">    
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
            <button type="submit" class="btn btn-primary" name="enviar" value="">Salvar</button>
          </div>
        </form>
      </div>
    </div>
