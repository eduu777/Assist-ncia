...
<body class="custom">
  ...
  <div class=" position-relative overflow-hidden py-5">
    <div class="col col-sm-12">
      <img src="../Imagens/loja/iphones.jpg" class="img-fluid" style="height: 590px; width: 100%;">
      <div data-aos="fade-in" data-aos-duration="900" class="text-white" style="position: absolute; top: 28%; left: 6%;">
        ...
        <p class="font-italic text-muted">Solicite um orçamento.</p>
        <a href="solicitarOrc.php"><button class="custom">Solicitar</button></a>
      </div>
    </div>
  </div>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12" data-aos="fade-up" data-aos-duration="2000">
            <div class="d-flex justify-content-center">
              <div class="col-8 offset-1">
                ...
                <figcaption class="blockquote-footer d-flex justify-content-center col-11">
                  Selecione qual problema seu aparelho possui.  
                </figcaption>
                <br>
                <a href="bateria.php"><button class="custom2"><i class="bi bi-battery custom2" style="font-size: 48px;"></i><br>Bateria / Não liga</button></a>
                <a href="aparelholento.php"><button class="custom2"><i class="bi bi-speedometer2 custom2" style="font-size: 48px;"></i><br>Aparelho lento</button></a>
                <a href="simcardnfunciona.php"><button class="custom2"><i class="bi bi-sim custom2" style="font-size: 48px;"></i><br>Sim card não funciona</button></a>
                <a href="tela.php"><button class="custom2"><i class="bi bi-phone custom2" style="font-size: 48px;"></i><br>Tela</button></a>
                <a href="audio.php"><button class="custom2"><i class="bi bi-volume-mute custom2" style="font-size: 48px;"></i><br>Problemas no áudio</button></a>
                <a href="camera.php"><button class="custom2"><i class="bi bi-camera custom2" style="font-size: 48px;"></i><br>Câmera</button></a>
                <a href="wifi.php"><button class="custom2"><i class="bi bi-wifi custom2" style="font-size: 48px;"></i><br>Wi-fi</button></a>
                <a href="gps.php"><button class="custom2"><i class="bi bi-geo-alt custom2" style="font-size: 48px;"></i><br>GPS / Localização</button></a>
              </div>
            </div> 
          </div>
        </div>
  ...
  <div class="container">
    <div class="row mx-auto">
      <div data-aos="fade-left" data-aos-duration="1700" class="col-lg-6 col-md-12 col-sm-12">
        ...
        <div>
          <a href="solicitarOrc.php"><button class="custom text-white" style="background-color: black;">Solicitar</button></a>    
        </div>        
      </div>
      <div data-aos="fade-right" data-aos-duration="1700" class="col-lg-6 col-md-12 col-sm-12">
...
<div id="about-area" class="d-flex justify-content-center">
  <div class="container">
    <div class="row mx-auto">
      <div data-aos="fade-right" data-aos-duration="1700" class="col-lg-6 col-md-12 col-sm-12">
        <img class="custom shadow" src="../Imagens/loja/assistenciafoto.jpg" style="height: 380px" alt="Empresa">
      </div>
      <div data-aos="fade-left" data-aos-duration="1700" class="col-lg-5 col-md-12 col-sm-12 offset-1 py-4">
  ...
  <div class="row text-center">
    ...
    <div class="col-xl-3 col-sm-6 mb-5" data-aos="flip-left" data-aos-duration="1700">
      <div class="bg-white rounded shadow-sm py-5 px-4"><img src="../Imagens/loja/dalker.png" alt="" style="height: 100px; width: 100px;" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        <h5 class="mb-0">Dalker Pinheiro</h5><span class="small text-uppercase text-muted">CEO</span>
        <ul class="social mb-0 list-inline mt-3">
          ...
          <li class="list-inline-item"><a href="https://www.instagram.com/dalkerpinheiro/" class="social-link"><i class="bi bi-instagram"></i></a></li>
    ...
    <div class="col-xl-3 col-sm-6 mb-5" data-aos="flip-left" data-aos-duration="1700">
      <div class="bg-white rounded shadow-sm py-5 px-4"><img src="../Imagens/loja/lais.jpeg" alt="" style="height: 100px; width: 100px;" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        <h5 class="mb-0">Laís Vieira</h5><span class="small text-uppercase text-muted">Gerente de Marketing</span>
        <ul class="social mb-0 list-inline mt-3">
          <li class="list-inline-item"><a href="#" class="social-link"><i class="bi bi-facebook"></i></a></li>
          <li class="list-inline-item"><a href="#" class="social-link"><i class="bi bi-twitter"></i></a></li>
          <li class="list-inline-item"><a href="https://www.instagram.com/laiis_.vieira/" class="social-link"><i class="bi bi-instagram"></i></a></li>
          <li class="list-inline-item"><a href="#" class="social-link"><i class="bi bi-linkedin"></i></a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="col-xl-3 col-sm-6 mb-5" data-aos="flip-left" data-aos-duration="1700">
      <div class="bg-white rounded shadow-sm py-5 px-4"><img src="../Imagens/loja/eduardo.jpg" alt="" style="height: 100px; width: 100px;" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        <h5 class="mb-0">Eduardo Nobre</h5><span class="small text-uppercase text-muted">Gerente</span>
        <ul class="social mb-0 list-inline mt-3">
          <li class="list-inline-item"><a href="#" class="social-link"><i class="bi bi-facebook"></i></a></li>
          <li class="list-inline-item"><a href="#" class="social-link"><i class="bi bi-twitter"></i></a></li>
          <li class="list-inline-item"><a href="https://www.instagram.com/eduardo_nobre.7/" class="social-link"><i class="bi bi-instagram"></i></a></li>
          <li class="list-inline-item"><a href="#" class="social-link"><i class="bi bi-linkedin"></i></a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="col-xl-3 col-sm-6 mb-5" data-aos="flip-left" data-aos-duration="1700">
      <div class="bg-white rounded shadow-sm py-5 px-4"><img src="../Imagens/loja/erik.png" alt="" style="height: 100px; width: 100px;" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        <h5 class="mb-0">Erik Bruno</h5><span class="small text-uppercase text-muted">Gerente de Design</span>
        <ul class="social mb-0 list-inline mt-3">
          <li class="list-inline-item"><a href="#" class="social-link"><i class="bi bi-facebook"></i></a></li>
          <li class="list-inline-item"><a href="#" class="social-link"><i class="bi bi-twitter"></i></a></li>
          <li class="list-inline-item"><a href="https://www.instagram.com/brun04b5/" class="social-link"><i class="bi bi-instagram"></i></a></li>
          <li class="list-inline-item"><a href="#" class="social-link"><i class="bi bi-linkedin"></i></a></li>
        </ul>
      </div>
    </div>
