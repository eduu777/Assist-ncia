  ...
  <div class="container-fluid">
    <div class="row flex-nowrap">
      ...
      <div data-bs-spy="scroll" class="col py-3">
        <div class="container-fluid">
          <h1 class="mt-4">Orçamentos Pendentes</h1>
          ...
          <div class="row">
            ...
            <tbody>
              ...
              if ($o['stts'] == "Orçamento Respondido") {?>
                <tr>
                  <td><?=$o['cod']?></td>
                  <td><?=$o['data']?></td>
                  <td><?=$o['hora']?></td>
                  <td><?=$o['stts']?></td>
                  <td><?php $daouser = new UsuarioDAO(); $client = $daouser->carregar($o['cod_cliente']); echo($client[0]['nome']);?></td>
                  <td><?php $daoorc_prod = new Orcamento_prodDAO(); $orc_prod = $daoorc_prod->carregar_orc($o['cod']); $daoprod = new ProdutoDAO(); $prod = $daoprod->carregar($orc_prod[0]['cod_produto']); echo($prod[0]['modelo']);?></td>
...
<script type="text/javascript">
  ...
  responderModal.addEventListener('show.bs.modal', function (event) {
              ...
              <script type="text/javascript">
                ...
                var open = document.getElementById('orcs');
                open.click();
              </script>
            </body>
            </html>
