          ...
          <div class="col-lg-12 col-md-12 col-sm-12" data-aos="fade-up" data-aos-duration="2000">
            <div class="d-flex justify-content-center">
              <div class="col-8 offset-1">
                ...
                <a href="View/aparelholento.php"><button class="custom2"><i class="bi bi-speedometer2 custom2" style="font-size: 48px;"></i><br>Aparelho lento</button></a>
                <a href="View/simcardnfunciona.php"><button class="custom2"><i class="bi bi-sim custom2" style="font-size: 48px;"></i><br>Sim card não funciona</button></a>
                <a href="View/tela.php"><button class="custom2"><i class="bi bi-phone custom2" style="font-size: 48px;"></i><br>Tela</button></a>
                <a href="View/audio.php"><button class="custom2"><i class="bi bi-volume-mute custom2" style="font-size: 48px;"></i><br>Problemas no áudio</button></a>
                <a href="View/camera.php"><button class="custom2"><i class="bi bi-camera custom2" style="font-size: 48px;"></i><br>Câmera</button></a>
                <a href="VIew/wifi.php"><button class="custom2"><i class="bi bi-wifi custom2" style="font-size: 48px;"></i><br>Wi-fi</button></a>
                <a href="View/gps.php"><button class="custom2"><i class="bi bi-geo-alt custom2" style="font-size: 48px;"></i><br>GPS / Localização</button></a>
              </div>
            </div> 
          </div>
        </div>
  ...
  <div class="row text-center">
    ...
    <div class="col-xl-3 col-sm-6 mb-5" data-aos="flip-left" data-aos-duration="1700">
      <div class="bg-white rounded shadow-sm py-5 px-4"><img src="Imagens/loja/erik.png" alt="" style="height: 100px; width: 100px;" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        <h5 class="mb-0">Ninguem teste 2</h5><span class="small text-uppercase text-muted">Gerente de Marketing</span>
        <ul class="social mb-0 list-inline mt-3">
          <li class="list-inline-item"><a href="#" class="social-link"><i class="bi bi-facebook"></i></a></li>
          <li class="list-inline-item"><a href="#" class="social-link"><i class="bi bi-twitter"></i></a></li>
